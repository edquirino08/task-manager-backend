...
app.use((req, res, next) => {
    const allowedOrigins = ['http://127.0.0.1:5174', 'http://127.0.0.1:5173', 'https://task-manager-frontend-eta.vercel.app']; // Adicione outras origens permitidas, se necessário
